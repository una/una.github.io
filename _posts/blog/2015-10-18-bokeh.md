...
## CSS Shapes and Isolation Mode

Now, we can also use CSS Shapes to create an outline of our figure, as well as `isolation-mode: isolate`. **Isolation mode** allows us to ignore blend modes occuring around us.
