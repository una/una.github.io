---
layout: post
title: 'An External SVG Symbol Sprite Icon System'
permalink: /svg-icons
date: '2016-01-26'
comments: true
tags:
...
header-bg: ../images/posts/svg-icons/icons.png
---
...
You can also set style render to generate a stylesheet that helps size icons, but I remove those (set to false above) because I like the icon to take the size of it's parent. These styles also correlate with the prefix option above.
