---
layout: post
title: CSS Image Effects &num;2&colon; 3D Glasses
permalink: /3d-effect
date: '2015-10-05'
comments: true
tags:
...
## 3D Images: AKA Anyglaphs


<img style="max-width: 600px" src="../images/posts/css-effects/2/anaglyph.jpg" alt="" class="left">

An anaglyph is a type of stereo 3D image created from two photographs taken approximately 2.5 inches apart, which is approximately the distance between human eyes.<sup><a href="http://stcroixstudios.com/wilder/anaglyph/whatsanaglyph.html">1</a></sup> This creates an illusion of depth and also means some people see 3D images in movies "better" than others depending on pupilary distance.
...
Okay, so what does that have to do with 3D images? *Everything!* If our intersecting pixels cancel-out to white, the original image pixel values are shown.
